...
CREATE TABLE `tb_cidades` (
  	...
  	`id_estado_tb_cidades` int(5) DEFAULT NULL,
	PRIMARY KEY (`id_cidade`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `tb_cidades` (`id_cidade`, `nome_cidade`, `id_estado_tb_cidades`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO `tb_estados` (`id_estado`, `nome_estado`, `uf`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
CREATE TABLE `tb_empresarios` (
	`id_empresario` int(3) NOT NULL AUTO_INCREMENT,
	`nome_completo` varchar(255) NOT NULL,
	`celular` char(11) NOT NULL UNIQUE,
	`cidade` int(4) NOT NULL,
	`cadastrado_em` DATETIME NOT NULL,
	`pai_empresarial` int(3),
	PRIMARY KEY (`id_empresario`)
);

ALTER TABLE `tb_empresarios` ADD CONSTRAINT `tb_empresarios_fk0` FOREIGN KEY (`cidade`) REFERENCES `tb_cidades`(`id_cidade`);

ALTER TABLE `tb_empresarios` ADD CONSTRAINT `tb_empresarios_fk1` FOREIGN KEY (`pai_empresarial`) REFERENCES `tb_empresarios`(`id_empresario`);

ALTER TABLE `tb_cidades` ADD CONSTRAINT `tb_cidades_fk0` FOREIGN KEY (`id_estado_tb_cidades`) REFERENCES `tb_estados`(`id_estado`);